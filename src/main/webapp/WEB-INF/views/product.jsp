...
<body>
		...
		<div class="tab-content" style="padding-top: 10px;">
			<div id="selling" class="tab-pane fade in active">
				...
				<div>
					...
					<table id="selling-table" data-toggle="table" data-click-to-select="true">
						<thead>
							<tr>
								<th data-checkbox="true"></th>
								<th data-field="title">产品信息</th>
	...
	function search_selling_product(){
		...
		if(title || code || group || inventory){
			...
			$.post("product/search", params, function(products){
				$('#selling-table').bootstrapTable('load', products);
			});
		}
		else{
			webix.message({
